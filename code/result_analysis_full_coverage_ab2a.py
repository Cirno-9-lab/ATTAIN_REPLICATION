...
# --- 路径配置（ab2-A 版本，使用 execution_result_ab2a.xlsx） ---
BASE_PATH = "/home/xinweimao/alv_evaluate/myResearch/workspace/dataset"
EXCEL_PATH = os.path.join(BASE_PATH, "execution_result_ab2a.xlsx")
...
def main():
    ...
    # 3. 计算评估指标（保持原有逻辑）
    print("正在计算评估指标 (ab2-A full-coverage)...")
    ...
    try:
        ...
        print("\n" + "=" * 58)
        print("📊 最终评估报告 (ab2-A, 逻辑传递后, full-coverage)")
        print("=" * 58)
