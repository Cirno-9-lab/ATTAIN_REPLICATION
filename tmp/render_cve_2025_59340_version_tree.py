...
ENTRY_SOURCE = WORKSPACE / 'tmp/cve_2025_59340_unified_time_scan_rq3.json'
SNAPSHOT_SOURCE = WORKSPACE / 'tmp/cve_2025_59340_matrix_latest.json'
OUTPUT_PATH = WORKSPACE / 'tmp/CVE-2025-59340_version_tree.svg'
