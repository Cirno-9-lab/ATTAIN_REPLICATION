...
ENTRY_SOURCE = WORKSPACE / 'tmp/cve_2019_20445_unified_time_scan_tree.json'
SNAPSHOT_SOURCE = WORKSPACE / 'tmp/cve_2019_20445_matrix_latest.json'
OUTPUT_PATH = WORKSPACE / 'tmp/CVE-2019-20445_version_tree.svg'
