...
ENTRY_SOURCE = WORKSPACE / 'tmp/cve_2013_7285_unified_time_scan.json'
SNAPSHOT_SOURCE = WORKSPACE / 'tmp/cve_2013_7285_matrix_latest.json'
OUTPUT_PATH = WORKSPACE / 'tmp/CVE-2013-7285_version_tree.svg'
